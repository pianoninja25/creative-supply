  ...
  return (
    <section className="py-4">
      <div className="w-full px-4">
        ...
        <div className="flex justify-center flex-wrap px-4 py-2 gap-3 md:gap-16">
          {boxList.map((a, idx) => (
            <div key={idx} className="w-[45%] md:w-[22%] h-[36vw] md:h-[18vw] rounded-[2rem] shadow-lg bg-cover" style={{backgroundImage:`url(/our-works/${a.bg})`}}>
              ...
              >
                <Link 
                  ...
                  className={`font-snowfun text-[9vw] md:text-[4vw] text-center leading-10 md:leading-none px-10 
      ...
      <div className={`grid justify-center gap-4 pt-12 md:hidden ${pathname.includes('services') ? 'hidden' : ''}`}>
